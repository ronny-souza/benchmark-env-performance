...
public class CsvController {
    ...
    @PostMapping("/read")
    public ResponseEntity<Void> read(@RequestParam("csv") MultipartFile csvFile) throws EmptyFileException, FileProcessorException {
        this.csvReaderService.read(csvFile);
        return ResponseEntity.ok().build();
    }
}
