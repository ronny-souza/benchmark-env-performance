...
class CsvReaderServiceTest {
    ...
    @Captor
    private ArgumentCaptor<List<Metadata>> metadataCaptor;
    ...
    void checkingIfCsvParserWorksCorrectly() throws FileProcessorException, EmptyFileException {
        ...
        /* Act */
        this.csvReaderService.read(multipartFile);

        Mockito.verify(this.metadataRepository).saveAll(metadataCaptor.capture());
        List<Metadata> metadatas = metadataCaptor.getValue();
